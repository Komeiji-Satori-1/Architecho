...
from .views import my_progress, my_overall_progress, my_stamp_for_monument, StampViewSet, StampColorLayerViewSet
...
urlpatterns = [
    ...
    path('my-overall-progress/', my_overall_progress),
